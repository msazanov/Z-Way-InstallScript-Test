...
- **Distribution and Architecture Selection**: You can select which distributions and architectures to test, allowing for flexible configuration.
  ...
  ![Distribution and Architecture Selection](img/docker_test_select_arch.png)
  *Рисунок 1: Выбор дистрибутива и архитектуры*
...
- **Real-time Test Progress and Status Display**: Each test's progress and status are displayed in real-time in a terminal table, showing which tests are in queue, testing, or completed.
  ...
  ![Test Progress](img/docker_test_select_arch2.png)
  *Рисунок 2: Реальное время прогресса теста и отображение статуса*

- **Automatic Cleanup of Containers on Exit**: The script ensures that all Docker containers are properly terminated and removed upon completion or interruption, preventing resource leaks.
